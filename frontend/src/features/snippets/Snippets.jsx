...
const SnippetCard = ({ snippet }) => {
  ...
  const langColors = {
    ...
    "c++": "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/20",
    cpp: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/20",
    csharp: "bg-purple-500/10 text-purple-600 dark:text-purple-400 border-purple-500/20",
    go: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border-cyan-500/20",
    rust: "bg-orange-600/10 text-orange-600 dark:text-orange-500 border-orange-600/20",
    php: "bg-violet-500/10 text-violet-600 dark:text-violet-400 border-violet-500/20",
    ...
    html: "bg-orange-400/10 text-orange-500 dark:text-orange-400 border-orange-400/20",
    ...
    shell: "bg-slate-700/10 text-slate-700 dark:text-slate-300 border-slate-700/20",
  };
...
export const Snippets = () => {
  const { error, searchQuery, setSearchQuery, activeTag, setActiveTag, selectedLanguage, setSelectedLanguage, getFilteredSnippets, getAllTags, getAllLanguages, fetchSnippets } = useSnippetStore();
