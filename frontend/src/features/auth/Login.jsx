        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 lg:p-10 shadow-2xl relative">
            ...
            <div className="grid grid-cols-2 gap-3 mt-6">
              <a href="/api/v1/auth/google" className="flex items-center justify-center py-3.5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all hover:scale-105 active:scale-95 group">
              ...
              <a href="/api/v1/auth/github" className="flex items-center justify-center py-3.5 rounded-2xl bg-white/5 hover:bg-[#181717]/80 border border-white/10 hover:border-white/20 transition-all hover:scale-105 active:scale-95 group">
